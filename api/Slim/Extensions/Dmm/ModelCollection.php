...
class ModelCollection extends \ArrayObject
{
     ...
     */
    public function __construct($modelClass='\Slim\Extensions\Dmm\BaseDomainModel')
    {
     ...
     */
    public function removeModel(\Slim\Extensions\Dmm\BaseDomainModel $model)
    {
     ...
     * @return boolean
     */
    public function contains(\Slim\Extensions\Dmm\BaseDomainModel $model)
    {
