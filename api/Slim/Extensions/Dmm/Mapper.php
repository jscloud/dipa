...
class Mapper
{
     ...
     * @var string
     */
    protected $modelClass = '\Slim\Extensions\Dmm\BaseDomainModel';
     ...
     * @var string
     */
    protected $modelCollectionClass = '\Slim\Extensions\Dmm\ModelCollection';
     ...
     * @return BaseDomainModel
     */
    public function find($identity, \Slim\Extensions\Dmm\BaseDomainModel $model)
    {
     ...
     * @return Mapper
     */
    public function insert(\Slim\Extensions\Dmm\BaseDomainModel $model)
    {
     ...
     * @return Mapper
     */
    public function update(\Slim\Extensions\Dmm\BaseDomainModel $model)
    {
     ...
     * @return Mapper
     */
    public function save(\Slim\Extensions\Dmm\BaseDomainModel $model)
    {
     ...
     * @return Mapper
     */
    public function delete(\Slim\Extensions\Dmm\BaseDomainModel $model)
    {
        list($whereCondition, $bindings) = $this->getIdentityCondition($model->__identity());
     ...
     * @return array
     */
    public function getValidationErrors(\Slim\Extensions\Dmm\BaseDomainModel $model)
    {
